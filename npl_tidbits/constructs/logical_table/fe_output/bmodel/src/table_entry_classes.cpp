...
void vlan_table_entry_t::set__VALID(_1bit value, int maxbit, int minbit) {
    uint i;
...
void vlan_table_entry_t::set__INDEX(_12bits value, int maxbit, int minbit) {
    uint i;
...
void vlan_table_entry_t::set_vid(_12bits value, int maxbit, int minbit) {
    uint i;
...
void vlan_table_entry_t::set_vlan_membership_bitmap(_128bits value, int maxbit, int minbit) {
    uint i;
    ...
    vlan_membership_bitmap(maxbit, minbit) = value;
}

void vlan_table_entry_t::set__LOOKUP0(_1bit value, int maxbit, int minbit) {
    uint i;
...
void vlan_table_entry_t::set__HIT_INDEX0(_32bits value, int maxbit, int minbit) {
    uint i;
...
vlan_table_entry_t::vlan_table_entry_t() {
    uint i;

    _VALID = (_1bit)(0x0U);
    _INDEX = (_12bits)(0x0U);
    vid = (_12bits)(0x0U);
    vlan_membership_bitmap = (_128bits)(0x0U);
    _LOOKUP0 = (_1bit)(0x0U);
    _HIT_INDEX0 = (_32bits)(0x0U);
}
...
void vlan_table_entry_t::print() {
#ifndef NO_CONSOLE_OUTPUT
    uint i;

    bmi_log->normal("vlan_table_entry_t->_VALID = 0x" + _VALID.to_string(SC_HEX_US, false));
    bmi_log->normal("vlan_table_entry_t->_INDEX = 0x" + _INDEX.to_string(SC_HEX_US, false));
    bmi_log->normal("vlan_table_entry_t->vid = 0x" + vid.to_string(SC_HEX_US, false));
    bmi_log->normal("vlan_table_entry_t->vlan_membership_bitmap = 0x" + vlan_membership_bitmap.to_string(SC_HEX_US, false));
    bmi_log->normal("vlan_table_entry_t->_LOOKUP0 = 0x" + _LOOKUP0.to_string(SC_HEX_US, false));
    bmi_log->normal("vlan_table_entry_t->_HIT_INDEX0 = 0x" + _HIT_INDEX0.to_string(SC_HEX_US, false));
#endif
}

void vlan_table_entry_t::pack_data(uint32_t *data) {
    uint32_t field;
    uint64_t ref_value;
    _64bits ref_addr;
    ...
    bm_field_set(data, 0, 0, &field);
    field = (uint32_t) _INDEX;
    bm_field_set(data, 1, 12, &field);
    field = (uint32_t) vid;
    bm_field_set(data, 13, 24, &field);
    field = (uint32_t) vlan_membership_bitmap.range(31, 0).to_int();
    bm_field_set(data, 25, 56, &field);
    field = (uint32_t) vlan_membership_bitmap.range(63, 32).to_int();
    bm_field_set(data, 57, 88, &field);
    field = (uint32_t) vlan_membership_bitmap.range(95, 64).to_int();
    bm_field_set(data, 89, 120, &field);
    field = (uint32_t) vlan_membership_bitmap.range(127, 96).to_int();
    bm_field_set(data, 121, 152, &field);
}

void vlan_table_entry_t::unpack_data(uint32_t *data) {
    uint32_t field;
    uint64_t ref_value;
    _64bits ref_addr;
    ...
    bm_field_get(data, 0, 0, &field);
    set__VALID((_1bit) field, -1, -1);
    bm_field_get(data, 1, 12, &field);
    set__INDEX((_12bits) field, -1, -1);
    bm_field_get(data, 13, 24, &field);
    set_vid((_12bits) field, -1, -1);
    bm_field_get(data, 25, 56, &field);
    set_vlan_membership_bitmap((_128bits) field, 31, 0);
    bm_field_get(data, 57, 88, &field);
    set_vlan_membership_bitmap((_128bits) field, 63, 32);
    bm_field_get(data, 89, 120, &field);
    set_vlan_membership_bitmap((_128bits) field, 95, 64);
    bm_field_get(data, 121, 152, &field);
    set_vlan_membership_bitmap((_128bits) field, 127, 96);
}
