...
class _BModel {
    ...
    /* table classes*/
    vlan_table_tab_t *vlan_table = NULL;
    ...
    /* table instances */
    vlan_table_entry_t *vlan_table_entry_LOOKUP0 = NULL;
    ...
    void _AUTO_KEY_GEN_vlan_table(_1bit lookup, _12bits *vid);
    void _AUTO_ACTION_vlan_table(vlan_table_entry_t *entry);
    ...
    void vlan_assign(void);
    void assign_destination(void);
    void ing_main(void);
    void egr_main(void);
