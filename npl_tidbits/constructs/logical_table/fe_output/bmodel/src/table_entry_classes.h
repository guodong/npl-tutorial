...
class vlan_table_entry_t {
public:
    _1bit _VALID;
    _12bits _INDEX;
    _12bits vid;
    _128bits vlan_membership_bitmap;
    _1bit _LOOKUP0;
    _32bits _HIT_INDEX0;

    void set__VALID(_1bit, int, int);
    void set__INDEX(_12bits, int, int);
    void set_vid(_12bits, int, int);
    void set_vlan_membership_bitmap(_128bits, int, int);
    void set__LOOKUP0(_1bit, int, int);
    void set__HIT_INDEX0(_32bits, int, int);
    vlan_table_entry_t(void);
    ~vlan_table_entry_t(void);
    void print(void);
    void unpack_data(uint32_t *data);
    void pack_data(uint32_t *data);
