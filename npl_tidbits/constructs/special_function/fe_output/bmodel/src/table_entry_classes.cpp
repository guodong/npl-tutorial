...
void sfc_timestamping_profile_entry_t::set__VALID(_1bit value, int maxbit, int minbit) {
    uint i;
...
void sfc_timestamping_profile_entry_t::set__INDEX(_1bit value, int maxbit, int minbit) {
    uint i;
...
void sfc_timestamping_profile_entry_t::set_timestamping_index(_1bit value, int maxbit, int minbit) {
    uint i;
    ...
    timestamping_index(maxbit, minbit) = value;
}

void sfc_timestamping_profile_entry_t::set_in_ts_enable(void* value, int maxbit, int minbit) {
    in_ts_enable = value;
}

void sfc_timestamping_profile_entry_t::set_out_ts_valid(void* value, int maxbit, int minbit) {
    out_ts_valid = value;
}

void sfc_timestamping_profile_entry_t::set_out_ts_val_sec(void* value, int maxbit, int minbit) {
    out_ts_val_sec = value;
}

void sfc_timestamping_profile_entry_t::set_out_ts_val_nsec(void* value, int maxbit, int minbit) {
    out_ts_val_nsec = value;
}

void sfc_timestamping_profile_entry_t::set__LOOKUP0(_1bit value, int maxbit, int minbit) {
    uint i;
...
void sfc_timestamping_profile_entry_t::set__HIT_INDEX0(_32bits value, int maxbit, int minbit) {
    uint i;
...
sfc_timestamping_profile_entry_t::sfc_timestamping_profile_entry_t() {
    uint i;

    _VALID = (_1bit)(0x0U);
    _INDEX = (_1bit)(0x0U);
    timestamping_index = (_1bit)(0x0U);
    in_ts_enable = (void*)(0x0U);
    out_ts_valid = (void*)(0x0U);
    out_ts_val_sec = (void*)(0x0U);
    out_ts_val_nsec = (void*)(0x0U);
    _LOOKUP0 = (_1bit)(0x0U);
...
void sfc_timestamping_profile_entry_t::print() {
#ifndef NO_CONSOLE_OUTPUT
    uint i;

    bmi_log->normal("sfc_timestamping_profile_entry_t->_VALID = 0x" + _VALID.to_string(SC_HEX_US, false));
    bmi_log->normal("sfc_timestamping_profile_entry_t->_INDEX = 0x" + _INDEX.to_string(SC_HEX_US, false));
    bmi_log->normal("sfc_timestamping_profile_entry_t->timestamping_index = 0x" + timestamping_index.to_string(SC_HEX_US, false));
    bmi_log->normal("sfc_timestamping_profile_entry_t->in_ts_enable = %p", in_ts_enable);
    bmi_log->normal("sfc_timestamping_profile_entry_t->out_ts_valid = %p", out_ts_valid);
    bmi_log->normal("sfc_timestamping_profile_entry_t->out_ts_val_sec = %p", out_ts_val_sec);
    bmi_log->normal("sfc_timestamping_profile_entry_t->out_ts_val_nsec = %p", out_ts_val_nsec);
    bmi_log->normal("sfc_timestamping_profile_entry_t->_LOOKUP0 = 0x" + _LOOKUP0.to_string(SC_HEX_US, false));
    bmi_log->normal("sfc_timestamping_profile_entry_t->_HIT_INDEX0 = 0x" + _HIT_INDEX0.to_string(SC_HEX_US, false));
#endif
}

void sfc_timestamping_profile_entry_t::pack_data(uint32_t *data) {
    uint32_t field;
    uint64_t ref_value;
    _64bits ref_addr;
    ...
    field = (uint32_t) timestamping_index;
    bm_field_set(data, 2, 2, &field);
    ref_value = (uint64_t) in_ts_enable;
...
void sfc_timestamping_profile_entry_t::unpack_data(uint32_t *data) {
    uint32_t field;
    uint64_t ref_value;
    _64bits ref_addr;
