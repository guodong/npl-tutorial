...
class _BModel {
    ...
    sfc_timestamping_profile_tab_t *sfc_timestamping_profile = NULL;
    ...
    sfc_timestamping_profile_entry_t *sfc_timestamping_profile_entry = NULL;
    ...
    sfc_bk_t *sfc_timestamping_profile__bk = NULL;
    ...
    void sfc_timestamping_profile__sfc_call(void*, int);
    ...
    virtual void sfc_timestamping_func(_1bit*, _1bit*, _32bits*, _32bits*);
