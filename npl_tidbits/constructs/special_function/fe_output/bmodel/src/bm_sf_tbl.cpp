...
void _BModel::_AUTO_sf_tbl_init(void)
{
    ...
    sfc_timestamping_profile_entry->set__VALID(1, -1, -1);
    sfc_timestamping_profile_entry->set_in_ts_enable((void*)&local_bus->ts_enable, -1, -1);
    sfc_timestamping_profile_entry->set_out_ts_valid((void*)&local_bus->ts_valid, -1, -1);
    sfc_timestamping_profile_entry->set_out_ts_val_sec((void*)&local_bus->ts_val_sec, -1, -1);
    sfc_timestamping_profile_entry->set_out_ts_val_nsec((void*)&local_bus->ts_val_nsec, -1, -1);
    sfc_timestamping_profile->write_entry(&sfc_idx_bits_1, sfc_timestamping_profile_entry);
