...
class sfc_timestamping_profile_entry_t {
public:
    _1bit _VALID;
    _1bit _INDEX;
    _1bit timestamping_index;
    void* in_ts_enable;
    void* out_ts_valid;
    void* out_ts_val_sec;
    void* out_ts_val_nsec;
    _1bit _LOOKUP0;
    _32bits _HIT_INDEX0;

    void set__VALID(_1bit, int, int);
    void set__INDEX(_1bit, int, int);
    void set_timestamping_index(_1bit, int, int);
    void set_in_ts_enable(void*, int, int);
    void set_out_ts_valid(void*, int, int);
    void set_out_ts_val_sec(void*, int, int);
    void set_out_ts_val_nsec(void*, int, int);
    void set__LOOKUP0(_1bit, int, int);
    void set__HIT_INDEX0(_32bits, int, int);
    sfc_timestamping_profile_entry_t(void);
    ~sfc_timestamping_profile_entry_t(void);
    void print(void);
