...
#
# Purpose:
#   To generate traffic for 'ing_pkt_counter' of logical register
#     construct example.
#
# Steps:
#   (a). Send 5 packet to port-0 of BM.
...
#
#{logical_register/reg_pkt_counter}$: python bm_tests/corp_net/testPkt.py
