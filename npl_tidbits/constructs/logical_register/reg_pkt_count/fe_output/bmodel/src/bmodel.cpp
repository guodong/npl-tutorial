...
_BModel::_BModel() { 
    ...
    register_ing_pkt_counter = new ing_pkt_counter;
...
_BModel::~_BModel() { 
    ...
    delete pkt;
    /* registers */
    delete register_ing_pkt_counter;
    /* table classes */
...
void _BModel::do_counter_update(void) {
    _32bits set_bits_32;
...
#endif
    set_bits_32 = (register_ing_pkt_counter->pkt_count + 1); 
    register_ing_pkt_counter->set_pkt_count(set_bits_32, -1, 0);
...
void _BModel::ing_main(void) {
    ...
    do_counter_update();
    printf("ing_pkt_counter = %d\n", (int)register_ing_pkt_counter->pkt_count);
