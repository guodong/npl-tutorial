...
enum pn_func_enum {
    ...
    PARSER_NODE_vlan_tag_enum,
    PARSER_NODE_snap_or_llc_enum,
    PARSER_NODE_snap_enum,
    PARSER_NODE_llc_enum,
...
class _BModel {
    ...
    /* packets */
    ing_pkt_t *ingress_pkt = NULL;

    /* table classes*/
    port_table_tab_t *port_table = NULL;
    vlan_protocol_table_tab_t *vlan_protocol_table = NULL;
    vlan_strength_profile_table_tab_t *vlan_strength_profile_table = NULL;
    ...
    /* table instances */
    port_table_entry_t *port_table_entry_LOOKUP0 = NULL;
    vlan_protocol_table_entry_t *vlan_protocol_table_entry_LOOKUP0 = NULL;
    vlan_strength_profile_table_entry_t *vlan_strength_profile_table_entry = NULL;
    ...
    void _AUTO_str_res_local_bus_vid(void);
    void _AUTO_KEY_GEN_port_table(_1bit lookup, _7bits *port_num);
    void _AUTO_KEY_GEN_vlan_protocol_table(_1bit lookup, _1bit *pkt_protocol);
    void _AUTO_ACTION_port_table(port_table_entry_t *entry);
    void _AUTO_ACTION_vlan_protocol_table(vlan_protocol_table_entry_t *entry);
    void _AUTO_PARSER_NODE_start(void);
    void _AUTO_PARSER_NODE_ethernet(void);
    void _AUTO_PARSER_NODE_vlan_tag(void);
    void _AUTO_PARSER_NODE_snap_or_llc(void);
    void _AUTO_PARSER_NODE_snap(void);
    void _AUTO_PARSER_NODE_llc(void);
    void _AUTO_PARSER_NODE_ingress(void);
    void base_assign_destination(void);
    void base_egress(void);
    void do_pkt_protocol_assignment(void);
    void ing_main(void);
    void egr_main(void);
