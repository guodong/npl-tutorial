...
class _BModel {
    ...
    /* table classes*/
    pri_cos_mapping_table_tab_t *pri_cos_mapping_table = NULL;
    dscp_cos_mapping_table_tab_t *dscp_cos_mapping_table = NULL;
    cos_strength_profile_table_tab_t *cos_strength_profile_table = NULL;
    ...
    /* table instances */
    pri_cos_mapping_table_entry_t *pri_cos_mapping_table_entry_LOOKUP0 = NULL;
    dscp_cos_mapping_table_entry_t *dscp_cos_mapping_table_entry_LOOKUP0 = NULL;
    cos_strength_profile_table_entry_t *cos_strength_profile_table_entry = NULL;
    ...
    void _AUTO_str_res_local_bus_cos(void);
    void _AUTO_KEY_GEN_pri_cos_mapping_table(_1bit lookup, _3bits *vlan_pri);
    void _AUTO_KEY_GEN_dscp_cos_mapping_table(_1bit lookup, _6bits *dscp);
    void _AUTO_ACTION_pri_cos_mapping_table(pri_cos_mapping_table_entry_t *entry);
    void _AUTO_ACTION_dscp_cos_mapping_table(dscp_cos_mapping_table_entry_t *entry);
    ...
    void do_default_strength_assignment(void);
    void ing_main(void);
    void egr_main(void);
