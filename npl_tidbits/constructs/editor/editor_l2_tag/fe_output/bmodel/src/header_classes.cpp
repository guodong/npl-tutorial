...
void grp_t::set_outer_tag(vlan_t *ref) {
    uint i;
    outer_tag->deep_copy(ref);
}

void grp_t::set_inner_tag(vlan_t *ref) {
    uint i;
...
void ing_pkt_t::set_grp(grp_t *ref) {
    uint i;
    grp->deep_copy(ref);
}
...
void ing_pkt_t::set_resetval() {
    ...
    grp->outer_tag->hdr_id = 1;
    hdr_ptr_array[1] = grp->outer_tag;
    grp->inner_tag->hdr_id = 2;
    hdr_ptr_array[2] = grp->inner_tag;
}
...
void egr_pkt_t::set_grp(grp_t *ref) {
    uint i;
    grp->deep_copy(ref);
}
...
void egr_pkt_t::set_resetval() {
    ...
    grp->l2->hdr_id = 3;
    hdr_ptr_array[0] = grp->l2;
    grp->outer_tag->hdr_id = 4;
    hdr_ptr_array[1] = grp->outer_tag;
    grp->inner_tag->hdr_id = 5;
    hdr_ptr_array[2] = grp->inner_tag;
}
