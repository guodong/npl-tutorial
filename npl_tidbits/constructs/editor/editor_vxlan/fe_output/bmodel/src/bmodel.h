...
enum pn_func_enum {
    ...
    PARSER_NODE_vxlan_enum,
    PARSER_NODE_inner_l2_enum,
    PARSER_NODE_inner_ipv4_enum,
...
class _BModel {
    ...
    void _AUTO_PARSER_NODE_vxlan(void);
    void _AUTO_PARSER_NODE_inner_l2(void);
    void _AUTO_PARSER_NODE_inner_ipv4(void);
    ...
    /* checksum prototypes */
    virtual void create_checksum0(_8bits*, egr_pkt_t*, _16bits*, _4bits*, _4bits*, _8bits*, _16bits*, _16bits*, _3bits*, _13bits*, _8bits*, _8bits*, _32bits*, _32bits*);

    /* update packet length prototypes */
    virtual void update_packet_length0(void*, void*, _16bits*, _8bits*, _8bits*);
    virtual void update_packet_length1(void*, void*, _16bits*, _8bits*, _8bits*);
