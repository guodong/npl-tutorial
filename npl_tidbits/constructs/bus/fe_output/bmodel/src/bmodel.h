...
enum pn_func_enum {
    ...
    PARSER_NODE_otag_enum,
    PARSER_NODE_itag_enum,
...
class _BModel {
    ...
    packet_field_bus_t *packet_field_bus = NULL;
    ...
    void _AUTO_PARSER_NODE_otag(void);
    void _AUTO_PARSER_NODE_itag(void);
    ...
    void do_populate_packet_field_bus(void);
    void do_access_packet_field_bus(void);
    void ing_main(void);
    void egr_main(void);
