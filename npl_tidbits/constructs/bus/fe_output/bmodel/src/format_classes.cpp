...
void packet_field_bus_t::set_src_ipv4_address_byte0(_8bits value, int maxbit, int minbit) {
    ...
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((src_ipv4_address_byte0(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    src_ipv4_address_byte0(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->src_ipv4_address_byte0: 0x" + src_ipv4_address_byte0.to_string(SC_HEX_US, false));
    }
#endif
    src_ipv4_address(7, 0) = src_ipv4_address_byte0(7, 0);
}

void packet_field_bus_t::set_src_ipv4_address_byte1(_8bits value, int maxbit, int minbit) {
    bool __print__value = false;
    uint i;
...
#ifndef NO_CONSOLE_OUTPUT
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((src_ipv4_address_byte1(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    src_ipv4_address_byte1(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->src_ipv4_address_byte1: 0x" + src_ipv4_address_byte1.to_string(SC_HEX_US, false));
    }
#endif
    src_ipv4_address(15, 8) = src_ipv4_address_byte1(7, 0);
}

void packet_field_bus_t::set_src_ipv4_address(_32bits value, int maxbit, int minbit) {
    bool __print__value = false;
    uint i;
...
#ifndef NO_CONSOLE_OUTPUT
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((src_ipv4_address(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    src_ipv4_address(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->src_ipv4_address: 0x" + src_ipv4_address.to_string(SC_HEX_US, false));
    }
#endif
    src_ipv4_address_byte0(7, 0) = src_ipv4_address(7, 0);
    src_ipv4_address_byte1(7, 0) = src_ipv4_address(15, 8);
}

void packet_field_bus_t::set_dst_ipv4_address_byte1(_8bits value, int maxbit, int minbit) {
    bool __print__value = false;
    uint i;
...
#ifndef NO_CONSOLE_OUTPUT
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((dst_ipv4_address_byte1(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    dst_ipv4_address_byte1(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->dst_ipv4_address_byte1: 0x" + dst_ipv4_address_byte1.to_string(SC_HEX_US, false));
    }
#endif
    dst_ipv4_address(15, 8) = dst_ipv4_address_byte1(7, 0);
}

void packet_field_bus_t::set_dst_ipv4_address_byte0(_8bits value, int maxbit, int minbit) {
    bool __print__value = false;
    uint i;
...
#ifndef NO_CONSOLE_OUTPUT
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((dst_ipv4_address_byte0(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    dst_ipv4_address_byte0(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->dst_ipv4_address_byte0: 0x" + dst_ipv4_address_byte0.to_string(SC_HEX_US, false));
    }
#endif
    dst_ipv4_address(7, 0) = dst_ipv4_address_byte0(7, 0);
}

void packet_field_bus_t::set_dst_ipv4_address(_32bits value, int maxbit, int minbit) {
    bool __print__value = false;
    uint i;
...
#ifndef NO_CONSOLE_OUTPUT
    if ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_ALL) ||
        ((bm_debug_lvl>=BM_DEBUG_LVL_DEBUG_NZ) && ((dst_ipv4_address(maxbit, minbit) != 0) or (value != 0)))) {
        __print__value = true;
    }

#endif
    dst_ipv4_address(maxbit, minbit) = value;

#ifndef NO_CONSOLE_OUTPUT
    if (__print__value) {
        bmi_log->normal("BM_DEBUG: packet_field_bus_t->dst_ipv4_address: 0x" + dst_ipv4_address.to_string(SC_HEX_US, false));
    }
#endif
    dst_ipv4_address_byte1(7, 0) = dst_ipv4_address(15, 8);
    dst_ipv4_address_byte0(7, 0) = dst_ipv4_address(7, 0);
}

packet_field_bus_t::packet_field_bus_t() {
    uint i;
...
void packet_field_bus_t::set_resetval(void) {
    uint i;

    src_ipv4_address_byte0 = (_8bits)(0x0U);
    src_ipv4_address_byte1 = (_8bits)(0x0U);
    src_ipv4_address = (_32bits)(0x0U);
    dst_ipv4_address_byte1 = (_8bits)(0x0U);
    dst_ipv4_address_byte0 = (_8bits)(0x0U);
    dst_ipv4_address = (_32bits)(0x0U);
}

void packet_field_bus_t::set_randval(void) {
    uint i;

    src_ipv4_address_byte0 = (_8bits)(rand());
    src_ipv4_address_byte1 = (_8bits)(rand());
    src_ipv4_address = (_32bits)(rand());
    dst_ipv4_address_byte1 = (_8bits)(rand());
    dst_ipv4_address_byte0 = (_8bits)(rand());
    dst_ipv4_address = (_32bits)(rand());
}

void packet_field_bus_t::print() {
#ifndef NO_CONSOLE_OUTPUT
    uint i;

    bmi_log->normal("packet_field_bus_t->src_ipv4_address_byte0 = 0x" + src_ipv4_address_byte0.to_string(SC_HEX_US, false));
    bmi_log->normal("packet_field_bus_t->src_ipv4_address_byte1 = 0x" + src_ipv4_address_byte1.to_string(SC_HEX_US, false));
    bmi_log->normal("packet_field_bus_t->src_ipv4_address = 0x" + src_ipv4_address.to_string(SC_HEX_US, false));
    bmi_log->normal("packet_field_bus_t->dst_ipv4_address_byte1 = 0x" + dst_ipv4_address_byte1.to_string(SC_HEX_US, false));
    bmi_log->normal("packet_field_bus_t->dst_ipv4_address_byte0 = 0x" + dst_ipv4_address_byte0.to_string(SC_HEX_US, false));
    bmi_log->normal("packet_field_bus_t->dst_ipv4_address = 0x" + dst_ipv4_address.to_string(SC_HEX_US, false));
#endif
}

int packet_field_bus_t::compare(packet_field_bus_t *ref, packet_field_bus_t *ref_mask) {
    uint mismatch = 0;
    uint i;

    if (ref_mask == NULL) {
        if (src_ipv4_address_byte0 != ref->src_ipv4_address_byte0) {
            mismatch = 1;
        }
    } else {
        if ((src_ipv4_address_byte0 & ref_mask->src_ipv4_address_byte0) != (ref->src_ipv4_address_byte0 & ref_mask->src_ipv4_address_byte0)) {
            mismatch = 1;
        }
    }

    if (ref_mask == NULL) {
        if (src_ipv4_address_byte1 != ref->src_ipv4_address_byte1) {
            mismatch = 1;
        }
    } else {
        if ((src_ipv4_address_byte1 & ref_mask->src_ipv4_address_byte1) != (ref->src_ipv4_address_byte1 & ref_mask->src_ipv4_address_byte1)) {
            mismatch = 1;
        }
    }

    if (ref_mask == NULL) {
        if (src_ipv4_address != ref->src_ipv4_address) {
            mismatch = 1;
        }
    } else {
        if ((src_ipv4_address & ref_mask->src_ipv4_address) != (ref->src_ipv4_address & ref_mask->src_ipv4_address)) {
            mismatch = 1;
        }
    }

    if (ref_mask == NULL) {
        if (dst_ipv4_address_byte1 != ref->dst_ipv4_address_byte1) {
            mismatch = 1;
        }
    } else {
        if ((dst_ipv4_address_byte1 & ref_mask->dst_ipv4_address_byte1) != (ref->dst_ipv4_address_byte1 & ref_mask->dst_ipv4_address_byte1)) {
            mismatch = 1;
        }
    }

    if (ref_mask == NULL) {
        if (dst_ipv4_address_byte0 != ref->dst_ipv4_address_byte0) {
            mismatch = 1;
        }
    } else {
        if ((dst_ipv4_address_byte0 & ref_mask->dst_ipv4_address_byte0) != (ref->dst_ipv4_address_byte0 & ref_mask->dst_ipv4_address_byte0)) {
            mismatch = 1;
        }
    }

    if (ref_mask == NULL) {
        if (dst_ipv4_address != ref->dst_ipv4_address) {
            mismatch = 1;
        }
    } else {
        if ((dst_ipv4_address & ref_mask->dst_ipv4_address) != (ref->dst_ipv4_address & ref_mask->dst_ipv4_address)) {
            mismatch = 1;
        }
    }
...
void packet_field_bus_t::deep_copy(packet_field_bus_t *ref) {
    uint i;

    src_ipv4_address_byte0 = ref->src_ipv4_address_byte0;
    src_ipv4_address_byte1 = ref->src_ipv4_address_byte1;
    src_ipv4_address = ref->src_ipv4_address;
    dst_ipv4_address_byte1 = ref->dst_ipv4_address_byte1;
    dst_ipv4_address_byte0 = ref->dst_ipv4_address_byte0;
    dst_ipv4_address = ref->dst_ipv4_address;
}

void packet_field_bus_t::unpack_data(uint32_t *_data, int offset) {
    uint32_t field;
    uint i;

    bm_field_get(_data, 0, 31, &field);
    set_src_ipv4_address((_32bits)field, -1, -1);
    bm_field_get(_data, 32, 63, &field);
    set_dst_ipv4_address((_32bits)field, -1, -1);
}

void packet_field_bus_t::pack_data(uint32_t *_data, int offset) {
    uint32_t field;
    uint i;

    field = (uint32_t) src_ipv4_address.range(31, 0).to_int();
    bm_field_set(_data, (offset + 0), (offset + 31), &field);
    field = (uint32_t) dst_ipv4_address.range(31, 0).to_int();
    bm_field_set(_data, (offset + 32), (offset + 63), &field);
}

int packet_field_bus_t::minbit() {
    return 0;
}

int packet_field_bus_t::maxbit() {
    return 63;
}
