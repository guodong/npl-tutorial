...
_BModel::_BModel() { 
    ...
    packet_field_bus = new packet_field_bus_t;
...
void _BModel::do_populate_packet_field_bus(void) {
    _32bits set_bits_32;
    ...
    packet_field_bus->set_src_ipv4_address(set_bits_32, 31, 0);
    set_bits_32 = ingress_pkt->l3_hdr->ipv4->dip; 
    packet_field_bus->set_dst_ipv4_address(set_bits_32, 31, 0);
...
void _BModel::do_access_packet_field_bus(void) {
...
#endif
    printf("Source ip address is 0X%x\n", (int)packet_field_bus->src_ipv4_address);
    printf("Destination ip address is 0X%x\n", (int)packet_field_bus->dst_ipv4_address);
    printf("Source ip address byte 0 is 0X%x\n", (int)packet_field_bus->src_ipv4_address_byte0);
    printf("Source ip address byte 1 is 0X%x\n", (int)packet_field_bus->src_ipv4_address_byte1);
    printf("Destination ip address byte 0 is 0X%x\n", (int)packet_field_bus->dst_ipv4_address_byte0);
    printf("Destination ip address byte 1 is 0X%x\n", (int)packet_field_bus->dst_ipv4_address_byte1);
