...
void _BModel::sfc_rtag7_hash_func(_32bits *in_header_ipv4__da,
                    _32bits *in_header_ipv4__sa,
                    _16bits *in_header_ipv4__src_port,
                    _16bits *in_header_ipv4__dst_port,
                    _8bits *in_header_ipv4__protocol,
                    _32bits *out_obj_bus__rtag7_hash) {
    *out_obj_bus__rtag7_hash = *in_header_ipv4__da ^ *in_header_ipv4__sa;
}
